...
export const keywords: CompletionItem[] = [
  ...
  {
    label: "formule",
    documentation: `Permet de définir la formule de la règle.
...
Liste des mécanismes disponibles : https://publi.codes/docs/api/mécanismes`,
  ...
  {
    label: "références",
    documentation: `Liste des références de la règle.
...
\`\`\``,
  ...
  {
    label: "valeur",
    documentation: `Permet de définir la valeur de la règle.
...
\`\`\``,
  ...
  {
    label: "question",
    documentation: `Permet de définir la question posée à l'utilisateur.
...
\`\`\``,
  ...
  {
    label: "résumé",
    documentation: `Permet de définir le résumé de la règle.
...
\`\`\``,
  ...
  {
    label: "icônes",
    documentation: `Permet de définir les icônes de la règle.
...
\`\`\``,
  ...
  {
    label: "suggestions",
    documentation: `Permet de définir les suggestions de la règle.
